...
const MobileNav = ({ setOpenNavbar, isLoggedIn, switchNetwork, showDialog, setShowDialog, activeNetwork, networks, deployedNetworks, chainId, setShowModal, installMetamask, connectWallet, changeNetwork, account }) => (
              ...
              <div className="relative">
                ...
                {showDialog
                  && (
                    <>
                      <div
                        className="absolute w-56 -top-1 h-3 display-none"
                        onMouseEnter={() => setShowDialog(true)}
                        onMouseLeave={() => setShowDialog(false)}
                      />
                      <div
                        className="absolute top-[-130px] w-[220px] px-4 py-3 rounded-xl white-glassmorphism z-20"
                        onMouseEnter={() => setShowDialog(true)}
                        onMouseLeave={() => setShowDialog(false)}
                      >
            ...
            <div>
              ...
              {showDialog
                && (
                  <>
                    <div
                      className="absolute w-60 bottom-[60px] right-[25px] h-2 display-none"
                      onMouseEnter={() => setShowDialog(true)}
                      onMouseLeave={() => setShowDialog(false)}
                    />
                    <div
